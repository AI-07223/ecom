...
The storefront SHALL access Medusa exclusively through a single TypeScript facade module (e.g., `platform/storefront/lib/commerce.ts`). Application code SHALL NOT import the Medusa SDK directly outside this facade.
