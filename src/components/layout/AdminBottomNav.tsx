    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-lg border-t safe-area-bottom">
            <div className="flex items-center h-16">
                ...
                <Link
                    href="/profile"
                    className="flex-shrink-0 flex flex-col items-center justify-center min-w-[56px] h-14 px-2 rounded-xl mx-0.5 text-muted-foreground hover:text-foreground"
                        ...
                        <div className="overflow-y-auto max-h-[calc(70vh-80px)] pb-8">
                            <div className="grid grid-cols-4 gap-3 pb-safe">
                                ...
                                <Link
                                    ...
                                    className="flex flex-col items-center justify-center p-4 rounded-2xl transition-all duration-200 hover:opacity-80 text-foreground"
                                    style={{ backgroundColor: `${settings.accent_color}08` }}
                                >
