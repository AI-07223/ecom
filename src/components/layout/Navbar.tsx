  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <nav className="container mx-auto px-4">
        ...
        {/* Mobile Navigation - Simplified: Back button, Logo, Search only */}
        <div className="md:hidden flex h-14 items-center gap-3">
          {/* Back Button - Shows on all pages except homepage */}
          {!isHomePage && (
            <button
              onClick={() => router.back()}
              className="flex-shrink-0 flex items-center justify-center w-10 h-10 rounded-full transition-all duration-200 active:scale-95 touch-manipulation"
