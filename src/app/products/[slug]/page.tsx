...
export default function ProductDetailPage() {
      ...
      try {
        ...
        if (productData.category_id) {
          const categoryDoc = await getDoc(
            doc(db, "categories", productData.category_id),
          );
  ...
  // Show wholeseller price for wholesellers if available
  const displayPrice =
    isWholeseller && product.wholeseller_price
      ? product.wholeseller_price
      : product.price;

  // Show retail price as crossed out for wholesellers when they get a better price
  ...
  const wholesaleDiscount =
    isWholeseller && product.wholeseller_price
      ? Math.round(
          ((product.price - product.wholeseller_price) / product.price) * 100,
        )
      : 0;
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-baseline gap-3">
            ...
            {wholesaleDiscount > 0 && (
              <Badge className="bg-green-600">Save {wholesaleDiscount}%</Badge>
            )}
          ...
          {isWholeseller && product.wholeseller_price && (
            <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
              <p className="text-sm text-green-800">
                <span className="font-semibold">Wholeseller Price:</span> You
                save {formatPrice(product.price - product.wholeseller_price)} on
                this item
              </p>
            </div>
          )}
