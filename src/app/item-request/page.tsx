...
export default function ItemRequestPage() {
    ...
    const uploadImages = async (): Promise<string[]> => {
        ...
        for (let i = 0; i < images.length; i++) {
            const file = images[i]
            const storageRef = ref(storage, `item_requests/${user!.uid}/${Date.now()}_${i}.jpg`)
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground">
                        Can&apos;t find what you&apos;re looking for? Submit a request and we&apos;ll try to source it for you.
                    </p>
                </div>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <Label htmlFor="requested_price">Expected Price ({settings.currency_symbol})</Label>
                                    <Input
                                        id="requested_price"
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground mb-2">
                                    Upload photos of the item you&apos;re looking for (max 5 images, ~300KB each)
                                </p>
