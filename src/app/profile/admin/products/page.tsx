...
import { Plus, Pencil, Trash2, Search, MoreHorizontal, ArrowLeft, Eye } from 'lucide-react'
...
function ProductsContent() {
    ...
    // Check if we should open form based on URL params
    useEffect(() => {
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    <Button
                        variant="ghost"
                        className="mb-6"
                        onClick={() => { setShowForm(false); resetForm(); router.push('/profile/admin/products'); }}
                    >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">
                                            This will be used in the product URL: /products/{formData.slug || 'slug'}
                                        </p>
                                    </div>
                                    <div className="col-span-2">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <Label htmlFor="compare_at_price">Compare at Price ({settings.currency_symbol})</Label>
                                        <Input
                                            id="compare_at_price"
                            ...
                            <TableBody>
                                {filteredProducts.map((product) => (
                                    <TableRow key={product.id}>
                                        ...
                                        <TableCell>
                                            <Badge variant={product.quantity > 5 ? 'secondary' : product.quantity > 0 ? 'outline' : 'destructive'}>
                                        ...
                                        <TableCell>
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    ...
                                                    <DropdownMenuItem className="text-red-600" onClick={() => setDeleteConfirm(product.id)}>
