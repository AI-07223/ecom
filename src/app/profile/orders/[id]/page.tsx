    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <nav className="flex items-center space-x-2 text-sm text-muted-foreground mb-6">
                ...
                <Link href="/profile/orders" className="hover:text-foreground">Orders</Link>
                <ChevronRight className="h-4 w-4" />
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <Badge
                    className={order.status === 'cancelled' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'}
                >
                                    ...
                                    {statusSteps.map((step, index) => (
                                        <div key={step} className="flex flex-col items-center flex-1">
                                            ...
                                            {index < statusSteps.length - 1 && (
                                                <div
                                                    className={`hidden sm:block absolute h-0.5 w-full mt-4 ${index < currentStepIndex ? 'bg-green-500' : 'bg-muted'
                                                        }`}
                                                />
                                            )}
                                        </div>
